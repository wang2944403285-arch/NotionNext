...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'landing', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '四下曲中', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Ordinary People', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-eight-gamma-63.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '吉他,乐理,乐句,Jazz,Funk,Blues,即兴,吉他谱,Sweep Picking', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '🎸 欢迎来到 Guitar Hub,🎵 探索吉他的无限可能,🎶 从乐理到即兴，一步一个脚印',
